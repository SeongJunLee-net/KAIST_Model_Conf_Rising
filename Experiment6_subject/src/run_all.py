...
os.chdir("/home/sjlee/hdd1/NLP/Experiment6")
...
# Many Change
def construct_interventions(data,tokenizer,base_model,DEVICE):
    interventions = {}
...
def run_all():
    ...
    interventions = construct_interventions(test_data,tokenizer,base_model,device)
